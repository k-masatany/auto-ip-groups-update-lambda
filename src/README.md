...
This is a sample template for auto-ip-groups-updater - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name auto-ip-groups-updater \
...
```bash
sam logs -n HelloWorldFunction --stack-name auto-ip-groups-updater --tail
```
...
```bash
aws cloudformation delete-stack --stack-name auto-ip-groups-updater
```
